...
export class ProductListComponent implements OnInit {
  ...
  onCartInit(): void {
    localStorage.setItem('currentCart',`${this.booksInCart}`);
    let myGet = localStorage.getItem('currentCart');
    console.log(myGet);
  }
  onAddItem(book: Book): void {
    // if (this.booksInCart) {}
    localStorage.setItem('currentCartTest',JSON.stringify(book));
    console.log(
      localStorage.getItem('currentCartTest')
    );
  }
  // Pagination Function
